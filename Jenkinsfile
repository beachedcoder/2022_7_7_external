...
//        e.g https://github.com/beachedcoder/2022_7_7_external.git might become https://github.com/MyName/external.git
// variables:
...
//      https://github.com/beachedcoder/2022_7_7_external.git
//      beachcoder
//      external
//      cluster-3 
    ...
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'master',
                    url: 'https://github.com/beachedcoder/2022_7_7_external.git'
